...
(meditations
  ...
  (= "Rich Hickey aka The Clojurer aka Go Time aka Macro Killah"
     (let [[first-name last-name & aliases]
       ...
       (clojure.string/join " "  (list first-name last-name "aka" (clojure.string/join " aka " aliases)))))
  ...
  (= "Test Testerson, 123 Test Lane, Testerville, TX"
     ((fn [[test testerson] {:keys [street-address city state]}]
        (apply str (interpose ", " (list (str test " " testerson) street-address city state))))
